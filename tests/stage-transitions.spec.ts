...
test.describe("Stage transitions @area:gameplay @slow", () => {
	...
	test.skip("play to BOSS_FIGHT (swipe through all cards, Next ticket until boss), assert boss question visible; complete boss 3+ correct → Quarter survived debrief", async ({
		page,
	}) => {
