// Primary CTA button (used in BossFight, FeedbackOverlay)
export const BTN_PRIMARY_CTA =
	"w-auto px-8 py-2.5 text-sm md:text-base bg-white text-black font-black tracking-wide hover:bg-cyan-500 transition-all shadow-xl transform active:scale-95";
